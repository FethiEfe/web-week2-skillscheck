...
// check if the number is greater than or equal to 5, return the string 'That looks like a big trip' from the function. 
...
function checkGroceryCount(){
   var num = groceries.length
    if(num >= 5){ return "That looks like a big trip"}
    else if(num ===1){ return '1 item'}
    else if(num >1 && num <5){return num + " " + "itemes"}
