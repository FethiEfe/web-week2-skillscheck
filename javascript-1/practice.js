...
// Code Here
var doubled = myNumbers.map(function(element){
	return element * 2;
})
...
// Code Here
var filtered = [];
filtered = myNumbers.filter(function(element){
	return element > 100;
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
var total = []
total = myNumbers.reduce(function(acc,val,i,arr){
	return acc + val
})
...
myNumbers.forEach(function(num,i,arr){
...
forTheLoveOfGeorge = notGeorge.map(function(val ,i ,arr){
	return arr[i] = "George"
})
...
// Code Here
var enemies = [],
enemies = people.filter(function(val, i , arr){
	return arr[i].friend !== true;
})
...
var totallyAwesome = [];
totallyAwesome = people.reduce(function(acc,val,i,arr){
